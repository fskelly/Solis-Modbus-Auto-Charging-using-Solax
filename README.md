...
Three files exist here - code for your dashboard, code for Template Sensors and code for Helpers.  Instructions on where to copy & paste exist within each repo file.
